...
<head>
	...
	<script src="https://api.mapbox.com/mapbox-gl-js/v3.7.0/mapbox-gl.js" async></script> <!--async=false y defer=true // el script se ejecuta tras la carga de la pagina-->
</head>
