...
class Circuito
{
    ...
    cargarXML(files)
    {
        ...
        if(archivo.type.match(tipoXML))
        {
            ...
            var nombre = $("p:nth-of-type(1)", seccionCampos).text("Nombre del archivo: " + archivo.name); // seleccionamos el elemento de la seccion y le asignamos el texto
		    var tamaño = $("p:nth-of-type(2)", seccionCampos).text("Tamaño del archivo: " + archivo.size + " bytes"); // seleccionamos el elemento de la seccion y le asignamos el texto
		    var tipo = $("p:nth-of-type(3)", seccionCampos).text("Tipo del archivo: " + archivo.type); // seleccionamos el elemento de la seccion y le asignamos el texto
		    var ultima = $("p:nth-of-type(4)", seccionCampos).text("Fecha de la última modificación: " + archivo.lastModifiedDate); // seleccionamos el elemento de la seccion y le asignamos el texto
		    var contenido = $("p:nth-of-type(5)", seccionCampos).text("Contenido del archivo de texto:"); // seleccionamos el elemento de la seccion y le asignamos el texto
