<?php 
	...
	class Moneda
	{
		...
		{
			$from = $this -> monedaLocal;
			$to = $this -> monedaDestino; 

			$apiKEY = 'gioOXU1RPXuJ1TVmeUG1UbceK6UqHzUmC8Sk';
			$url = 'https://currencyapi.net/api/v1/convert?key=' . $apiKEY . '&amount=1.0&from=' . $from . '&to=' . $to . '&output=JSON';
...
<body>
	...
	<main>
		...
		<?php 
			...
			$convertidorMoneda -> computarCambioDeMoneda();
		?>
