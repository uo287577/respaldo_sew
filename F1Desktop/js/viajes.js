...
class Viajes
{
    ...
    cargarMapaEstatico()
    {
        if(this.permisoConcedido)
        {
            ...
            var tamMapa = "800x600"; // se define el tamaño en pixeles
            var colorPin = "ff0000";
        ...
        } else
        {
            ...
            var textoPermisoNoConcedido = document.createTextNode("Permiso de ubicación dengado, no se ha podido cargar el mapa estático");
